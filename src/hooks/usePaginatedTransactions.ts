...
/* bug 4 fix.
Approach taken: The goal is to ensure that when new data is loaded, it is appended to the existing transactions without replacing them entirely, thus preventing the loss of initial transactions.
